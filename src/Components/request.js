const requests = {
    fetchTrending: `/movies/genres/6`,
//     fetchNetflixOriginals: `/discover/tv?api_key=${process.env.REACT_APP_API_KEY}&with_network=123`,
//     fetchTopRated: `/movie/top_rated?api_key=${process.env.REACT_APP_API_KEY}&language=en-US`,
    fetchActionMovies: `/movies/genres/1`,
    ...
    fetchThrillerMovies: `/movies/genres/4`
};
